        ...
        {selectMode ? (
          ...
          <div onClick={(e) => e.stopPropagation()}>
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="flex flex-col gap-1 bg-[#181818]">
                <DropdownMenuItem
                  onClick={() => togglePin(item)}
                  className="p-2.5 rounded-br-sm rounded-bl-sm h-fit text-zinc-500 bg-[#2a2a2a] border-0 font-semibold grid grid-cols-[20px_1fr]"
                >
                ...
                <DropdownMenuItem
                  ...
                  className="p-2.5 rounded-sm h-fit text-zinc-500 bg-[#2a2a2a] border-0 border-zinc-300 font-semibold grid grid-cols-[20px_1fr]"
                >
                  <Share />
                  <span>Share</span>
                </DropdownMenuItem>
                ...
                <DropdownMenuItem
                  ...
                  className="p-2.5 rounded-tr-sm rounded-tl-sm h-fit text-red-500 bg-red-100 border-0 border-red-200 font-semibold grid grid-cols-[20px_1fr]"
                >
                  <Trash2 color="red" />
                  Delete
                </DropdownMenuItem>
